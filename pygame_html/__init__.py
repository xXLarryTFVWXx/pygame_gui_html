...
class Parser(html.parser.HTMLParser):
    ...
    def handle_img_tag(self, attrs):
        ...
        if "global" in attributes.keys():
            ...
            pygame.event.post(pygame.Event(LOAD_IMAGE, {'image': pygame.image.load(attributes.get('src', "error.png"))}))
            if __debug__:
